...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=00F7FF&center=true&vCenter=true&pause=1000&width=700&lines=Java+Backend+Developer;Spring+Boot+%7C+REST+APIs;Cloud+%26+Infrastructure+Background;Docker+%7C+AWS+%7C+Linux;Always+Learning+and+Building" />
</p>
...
⚙️ Background in Infrastructure, Linux, Networking and Observability

☁️ AWS Student Ambassador

🔭 Currently working with Infrastructure Monitoring, Virtualization and Cloud Environments

🐳 Studying Software Architecture, Docker, Kubernetes and CI/CD

🎯 Looking for opportunities as a Backend Developer (Java)
